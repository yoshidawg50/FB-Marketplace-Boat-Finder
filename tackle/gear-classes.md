...
The KB describes gear in **class terms** (jig-stick class, 40–60 lb class,
200g-knife-jig class) so a species/technique note can say "reach for the
surface-iron class" and a **profile lookup** resolves that to the actual rod a
given angler owns. This note is that lexicon. Worked example throughout:
[Cameron's rods](../profiles/cameron/rods.md). Selection logic is in
