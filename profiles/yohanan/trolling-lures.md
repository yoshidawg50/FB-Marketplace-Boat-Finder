---
type: profile
tags: [yohanan, trolling, lures, inventory]
sources: []
confidence: medium
---
...
## Swimmers / divers
- <model — color — condition> → [DTX](../../lures/dtx-minnow.md) / [Halco](../../lures/halco-laser-pro.md) / [Rapala](../../lures/rapala-husky-magnum.md)

## High-speed
- <model> → [Mad Mac](../../lures/mad-mac.md)

## Cedar / skirts / feathers / bars
- <model> → [cedar plug](../../lures/cedar-plug.md) / [feathers & skirts](../../lures/tuna-feathers-and-skirts.md) / [spreader bar](../../lures/spreader-bar.md)

## Spread rules
- Number of lines you run; which holder takes the furthest-back lure; top-shot
  preferences.
